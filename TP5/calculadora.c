...
double calculo(int *controle, t_pilha *pilha_valores, t_pilha *pilha_operadores, double m) {
...
int main ()
{
    ...
    while (controle)
    {
        m = calculo(&controle,pilha_valores,pilha_operadores,m);
    }
